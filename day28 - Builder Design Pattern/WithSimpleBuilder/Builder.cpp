...
private:
    ...
    // object of this cannot be created using the new keyword
    //  Private constructor - can only be accessed by the Builder
    HttpRequest() {}

public:
    // friend keyword --> basically you are allowing the HttpRequestBuilder to access your private members . which was not possible even with inheritance
